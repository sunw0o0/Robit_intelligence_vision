    ...
    , ui(new Ui::MainWindow)
{
    ...
    ranges[vision::WHITE]  = {   0, 179,    0,   204, 97, 255 };
    ranges[vision::BLUE]   = {  97, 137,  100,  255,  35, 255 };
    ranges[vision::NEON]   = {  30,  65,   80,  255, 100, 255 };
    ranges[vision::ORANGE] = {   0,  28,  130,  255, 110, 255 };
...
void MainWindow::processFrame()
{
    ...
    // 위치 표시: 하얀선 기준(up/down), 파란선 기준(right/left), 사분면
    auto showPos = [](QLabel *w, QLabel *b, QLabel *q, const vision::ConeResult &c) {
        const bool valid = c.found && c.pos != vision::Pos::Unknown;
        w->setText(valid ? QString::fromUtf8(vision::whiteSideName(c.whiteSide)) : QString("-"));
        b->setText(valid ? QString::fromUtf8(vision::blueSideName(c.blueSide))   : QString("-"));
        q->setText(QString::fromUtf8(vision::posName(c.pos)));
    };
    showPos(ui->neon_white,   ui->neon_blue,   ui->neon_Q,   r.neon);
    showPos(ui->orange_white, ui->orange_blue, ui->orange_Q, r.orange);
